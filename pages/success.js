export default () => {
    return <>
        ...
        <div className="mx-auto text-center my-16">
            ...
            <br/>
            <p className="inline-block my-8 bg-white rounded-lg border-4 border-solid border-gray-300 py-2 px-4 text-3xl">Thank you for your submission. Results will be released soon.</p>
        </div>
    </>
}
