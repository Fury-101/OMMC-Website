                    ...
                    <div className="flex">
                        <div className="self-center">
                            ...
                            <p className="mt-4 mb-3 max-w-2xl text-xl text-gray-500 ">
                                We are currently led by Evan Chang, Ishaan
                                Akula, and Bill Fei, who serve as the directors.
                            </p>
                        </div>
                        <div className="md:flex">
                            <div className="mt-8">
                                ...
                                <p className="ml-16 max-w-2xl  text-gray-500">
                                    Our staff consists of highly qualified and
                                    experienced individuals who are highly
                                    committed to our cause of advancing math
                                    education.
                                </p>
                            </div>
                            <div className="mt-8">
                                ...
                                <p className="ml-16 max-w-2xl  text-gray-500">
                                    Staff members have excelled at AMC 10/12,
                                    AIME, USAJMO and USAMO, and some members
                                    have attended the prestigious MOP summer
                                    program.
                                </p>
                            </div>
                            <div className="mt-8">
                                ...
                                <p className="ml-16 max-w-2xl  text-gray-500">
                                    Our competition problems have been
                                    selectively written, chosen and reviewed by
                                    math students around the world to be
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="self-center ">
                            ...
                            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                                Our current competition consists of 1 round of
                                25 questions for a team of up to 4 people,
                                administered over the span of 10 whole days,
                                consisting of questions with similar difficulty
                                as those posed on the well-established MAA math
                                competitions.
                            </p>
                        </div>
                    </div>
                        ...
                        <ol className="relative border-l border-gray-300 ">
                            ...
                            <li className="mb-10 ml-4">
                                ...
                                <p className="mb-4 text-base font-normal text-gray-500">
                                    The OMMC contest will be held through these
                                    days.
                                </p>
                            </li>
                            <li className="mb-10 ml-4">
                                ...
                                <p className="text-base font-normal text-gray-500">
                                    Participants will be allowed to discuss the
                                    competition.
                                </p>
                            </li>
                            <li className="mb-10 ml-4">
                                ...
                                <p className="text-base font-normal text-gray-500 ">
                                    Solutions are released, winners announced,
                                    and prizes sent out.
                                </p>
                            </li>
                            <li className="ml-4">
                ...
                <div className="justify-center flex max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
                    ...
                    <div className="md:flex">
                        <div className="mt-5">
                            ...
                            <p className="ml-16 max-w-2xl  text-gray-500 ">
                                Prizes shouldn’t be the main reason someone
                                takes OMMC, but in previous years we have been
                                sponsored by organizations such as AoPS,
                                Maplesoft, and Wolfram Alpha, who have provided
                                hundreds of dollars to top scoring competitors.
                        ...
                        <div className=" mt-5">
                            ...
                            <p className="ml-16 max-w-2xl  text-gray-500">
                                Students will have the opportunity to compete in
                                teams, developing valuable teamwork and
                                collaboration skills. In the competition, they
                                will be able to solve thought-provoking
                                challenging mathematics questions. They will
                                also be able to reap the benefits of our
                                educational materials and community Discord
                                server.
                            </p>
                        </div>
                    </div>
            ...
            <div className="flex bg-white place-content-center">
                ...
                <div className="mr-10 ml-10 place-content-center mt-10 mb-10 ">
                    ...
                    <p className="mt-4 max-w-2xl text-xl text-gray-500 ">
                        We highly recommend competitors join our Community
                        Discord for the latest updates on OMMC. There is no sign
                        up process for OMMC this year.
                    </p>
                    <div>
                        ...
                        <p className="ml-16 max-w-2xl text-gray-500 mt-10">
                            Because the competition is untimed, we have chosen
                            to let teams just fill out their registration
                            information with their final submission. The test
                            portal will be linked on this page during the
                            testing period.
                        </p>
                    </div>
                    <dt>
                        ...
                        <p className="ml-16 max-w-2xl  text-gray-500 mt-10">
                            Solo participants are allowed and will be treated
                            simply as one man teams. They will be eligible for
                            the same prizes as teams with multiple people.
                        </p>
                    </dt>
                </div>
            </div>
